...
abstract class Modal {
    ...
    protected getModalHeader():HTMLElement {
    ...
    //abstract classes to implement to any class that extends this class
    abstract setModalBodyDetails(modalBody: [{}]):void;
    //this class cannot be access outside the the class that extends the modal class
    protected abstract getModalBody():HTMLElement;
