import { BulletPoints, AcademicAttributes } from './Interfaces.js';
import ElementCreate from './ElementCreate.js';

class Academic {
    //constructor declaration
    constructor(private academicDetails: AcademicAttributes) {
        this.academicDetails = academicDetails;
    }

    getAcademic(): HTMLElement {
        ...
        const medal: string[] = BulletPoints.MEDAL.split(" ");
        ...
        this.academicDetails.outcome.forEach( knowledge => {
            ...
            const bulPointClass: string[] = BulletPoints.ACADEMIC.split(" ");
