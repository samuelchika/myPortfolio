import { SkillDetails } from './utilities/Interfaces.js';
import ElementCreate from './utilities/ElementCreate.js';

class Skills {

    private skillsArray: Array<SkillDetails> = [];

    constructor(skill: Array<SkillDetails>) {
       this.skillsArray = skill;        
    }

    getSkills():HTMLElement {
    ...
    private buildHousingDiv(skill: SkillDetails): HTMLElement {
        const div = new ElementCreate('div');
    ...
    private buildEnclosingDiv(skill: SkillDetails): HTMLElement {
        const div = new ElementCreate('div');
    ...
    private buildSkillText(skill: SkillDetails): HTMLElement {
        const div = new ElementCreate('div');
    ...
    private buildFontAwesomeParagraph(skill: SkillDetails): HTMLElement {
    ...
    private buildFontAwesomeIcon(skill: SkillDetails): HTMLElement {
    ...
    private buildProgressBarDiv(skill: SkillDetails): HTMLElement {
        const div = new ElementCreate('div');
    ...
    private progBarInner(skill: SkillDetails):HTMLElement {
        const div = new ElementCreate('div');
