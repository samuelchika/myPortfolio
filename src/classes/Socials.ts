import { SocialDetails } from './utilities/Interfaces.js';
import ElementCreate from './utilities/ElementCreate.js';

class Socials {
    private socialLinks: SocialDetails[] = [];

    constructor(details: SocialDetails[]) {
        this.socialLinks = details;
    }

    getSocials():HTMLElement {
        ...
        this.socialLinks.forEach((link, index) => {
            ...
            const fAwesomeClasses: string[] = link.fAwesome.split(" ");
